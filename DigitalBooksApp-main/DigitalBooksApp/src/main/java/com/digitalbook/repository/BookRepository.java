...
public interface BookRepository extends JpaRepository<Book, Serializable> {
	...
	List<Book> findByBooks(@Param("title") String title, @Param("authorName") String authorName,
			@Param("publisher") String publisher, @Param("rdate") LocalDate rdate);
	...
	int editBookDetails(@Param("title") String title, @Param("category") String category, @Param("price") float price,
			@Param("author") String author, @Param("publisher") String publisher, @Param("rdate") LocalDate localDate,
			@Param("active") boolean active, @Param("bid") int bid, @Param("aid") int aid);
